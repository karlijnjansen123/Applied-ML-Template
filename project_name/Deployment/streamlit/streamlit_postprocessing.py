...
dict_features_change = {"bodyweight":"Your weight",
                        ...
                        "friendcounton": "If you think you have friends you can count on when things go wrong",
...
def output_model_streamlit(text):
    ...
    features_bodyimage = predictions_dict["Top features attributing to body image prediction"]
